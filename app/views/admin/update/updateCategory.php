...
<div class="container mt-5">
    ...
    <form action="/admin/category/updateCategory?id=<?= $cate['id'] ?>" method="post" enctype="multipart/form-data">
        <div class="mb-3">
            <label for="productName" class="form-label">Tên danh mục</label>
            <input name="name" type="text" class="form-control" id="productName" placeholder="Nhập tên danh mục" >
            <?php
