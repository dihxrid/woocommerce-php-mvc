...
<div class="container mt-5">
    ...
    <form action="/admin/User/updateUser?id=<?= $users['id'] ?>" method="post" enctype="multipart/form-data">
        <div class="mb-3">
            <label for="productName" class="form-label">Tên đăng nhập</label>
            <input name="id" type="text" class="form-control" id="userName" placeholder="Nhập tên đăng nhập" value="<?= $users['username'] ?>">
            <?php
            if (isset($errors['id'])) {
        ...
        <div class="mb-3">
            <label for="productName" class="form-label">Mật khẩu</label>
            <input name="name" type="text" class="form-control" id="productName" placeholder="Nhập tên sản phẩm" value="<?= $categories['name'] ?>">
            <?php
            if (isset($errors['name'])) {
                echo '<p class="text-danger">' . $errors['name'] . '</p>';
